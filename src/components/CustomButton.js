...
const CustomButton = ({ buttonName,margingTOP,btnTextColor, btnColor = COLORS.themeColor, onPress, disabled = false,Loader }) => {
  return (
    <TouchableOpacity
    ...
    >
      ...
      {
        Loader ?(
 <ActivityIndicator  style ={{marginLeft:5}}color={COLORS.white} size={'small'} />
        ):null
      }
      </View>
